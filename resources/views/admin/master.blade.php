...
<!-- END PAGE VENDOR JS-->
<!-- BEGIN MODERN JS-->
<script src="{{ asset('bower_components/tracking_theme/app-assets/js/core/app-menu.js') }}"></script>
<script src="{{ asset('bower_components/tracking_theme/app-assets/js/core/app.js') }}"></script>
